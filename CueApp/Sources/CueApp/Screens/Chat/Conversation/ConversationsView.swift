...
struct RightSidebarView: View {
    ...
    private var emptyStateView: some View {
        ...
        .padding()
        .animation(.default, value: viewModel.searchText.count >= 3) // Only animate the content switch
    }
    ...
    private var footerView: some View {
        Button {
            ...
            Task {
                if let newId = await viewModel.createConversation(provider: provider) {
                    viewModel.selectConversation(newId)
