...
struct OpenAIWindowView: View {
    ...
    var body: some View {
        let apiKey = dependencies.apiKeyProviderViewModel.getAPIKey(for: APIKeyType.openai)
...
struct AnthropicWindowView: View {
    ...
    var body: some View {
        let apiKey = dependencies.apiKeyProviderViewModel.getAPIKey(for: APIKeyType.anthropic)
