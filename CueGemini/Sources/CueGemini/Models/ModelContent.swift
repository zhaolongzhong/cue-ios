/// https://github.com/google-gemini/generative-ai-swift/blob/main/Sources/GoogleAI/ModelContent.swift
...
extension ModelContent.Part: Codable {
  ...
  enum InlineDataKeys: String, CodingKey {
    case mimeType = "mimeType" // multimodal live api uses 'mimeType'
    case bytes = "data"
  }
