...
public enum AudioManagerError: LocalizedError, Equatable {
...
public enum AudioManagerState: Equatable {
    case idle
    case started
    case paused
    case resumed
    ...
    public var description: String {
        ...
        case .playing(let id): return "playing(\(id ?? "nil"))"
...
public class AudioManager: NSObject, @unchecked Sendable {
    ...
    @MainActor
    public func setupAudioEngine() async throws {
